...
public class FindAllPassengersMBean implements Serializable {
	...
	private static final String EMPTY_LIST_MESSAGE = "<i class='fa fa-times'></i>" + "No passengers for this trip.";
	@EJB
	...
	public String getTrip() {
		StringBuilder result = new StringBuilder(tripDepartureCity);
		result.append(" - ");
