...
public class FindTripsMBean implements Serializable {
	...
	private final String emptyListMessage = "<i class='fa fa-times'></i> La seva cerca no ha produït resultats...";
	...
	public void findTrips() throws NamingException {
		...
		tripFacadeRemote = (TripFacadeRemote) ctx.lookup("java:app/CAT-PDP-GRUP6.jar/TripFacadeBean!ejb.TripFacadeRemote");
